...
class Toast {
    ...
    setupPauseOnHover() {
        ...
        this.element.addEventListener('mouseenter', () => {
            ...
            if (progressBar) {
                ...
                /** @type {HTMLElement} */ (progressBar).style.setProperty('--animation-play-state', 'paused');
            }
        });
    ...
    applyProgressBar() {
        ...
        /** @type {HTMLElement} */ (progressBar).style.setProperty('--progress-duration', `${this.config.timeout}ms`);
        /** @type {HTMLElement} */ (progressBar).style.setProperty('--animation-play-state', 'running');
