    ...
    */
    ...
    function handleChange(e) {
        ...
        if(field.dateRange) {
            ...
            onChange && field && e.start && onChange({
                name: field.name, 
                value: {
                    start: e.start.toISOString(),
...
<div class="advanced-filter--date-picker">
    <DatePicker isEuropean={!field?.isAmerican} isRange={field.dateRange} quickSelect manualInput onChange={handleChange} bind:this={datepicker}/>
</div>