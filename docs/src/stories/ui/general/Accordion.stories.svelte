<script module>
	...
	import { Accordion, AccordionItem } from '@ui/general';

	// More on how to set up stories at: https://storybook.js.org/docs/writing-stories
	const { Story } = defineMeta({
		title: 'UI/General/Accordion',
		component: Accordion,
		tags: ['autodocs'],
		argTypes: {
...
<Story name="Default Accordion" args={{ multiple: false, flush: false }}>
					...
					<a href="/">
						<svg
							...
							></g><g id="SVGRepo_iconCarrier">
								<path d="M2 3L22 3" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"
								></path>
								<path
...
<Story name="Flush Accordion" args={{ multiple: false, flush: true }}>
	{#snippet children(args)}
		<Accordion {...args}>
			<AccordionItem title="Accordion Item 1" list>
				<li>
...
<Story name="Open Multiple" args={{ multiple: true, flush: false }}>
	{#snippet children(args)}
		<Accordion {...args}>
			<AccordionItem title="Accordion Item 1" list>
				<li>
